...
import MouseWheelHandlerMixin from 'ember-table-one/mixins/mouse-wheel-handler';
import TouchMoveHandlerMixin from 'ember-table-one/mixins/touch-move-handler';
import ScrollHandlerMixin from 'ember-table-one/mixins/scroll-handler';
