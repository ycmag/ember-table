...
import ResizeHandlerMixin from 'ember-table-one/mixins/resize-handler';
import RowArrayController from 'ember-table-one/controllers/row-array';
import Row from 'ember-table-one/controllers/row';
